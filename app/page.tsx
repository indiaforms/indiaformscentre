...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Services Showcase */}
      <section className="bg-white dark:bg-slate-900 py-20 border-b border-neutral-100 dark:border-slate-800 transition-colors duration-300">
        <div className="container-px max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-neutral-50 dark:bg-slate-800/40 rounded-2xl p-6 space-y-4 hover:shadow-xl hover:shadow-neutral-200/30 dark:hover:shadow-black/20 transition-all border border-neutral-100 dark:border-slate-800/60">
      ...
      <section className="bg-cream py-24 transition-colors duration-300">
        <div className="container-px max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div className="space-y-2">
              <h2 className="text-xs font-bold tracking-[0.2em] uppercase text-primary">Our Collections</h2>
          ...
          {products.length === 0 ? (
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-12 text-center text-neutral-400 dark:text-neutral-500 shadow-sm border border-neutral-100 dark:border-slate-700/60">
      ...
      <section id="contact" className="bg-slate-900 text-white py-24">
        <div className="container-px max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-xs font-bold tracking-[0.2em] uppercase text-secondary">Get a Quote</h2>
            ...
            <div className="space-y-4 pt-4 border-t border-slate-800">
              <div>
                <span className="block text-xs font-bold uppercase tracking-wider text-slate-500">Corporate Helpline</span>
                <span className="text-lg font-semibold text-white">+91 98765 43210</span>
              </div>
              <div>
                <span className="block text-xs font-bold uppercase tracking-wider text-slate-500">Office Location</span>
                <span className="text-slate-400 text-sm">Level 6, Tech Park Center, Mumbai, India</span>
              </div>
            </div>
          </div>
          
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-700 to-emerald-600 rounded-2xl blur-lg opacity-25" />
